    ...
    <div className='container lg:text-center mx-auto bg-white mt-10  '>
        ...
        <div className='py-5 my-5 grid grid-cols-1  lg:grid-cols-3 gap-3'>
           <div className='flex text-center lg:text-left flex-col'>
              <Image src="/mobilelogo.svg" alt="mobileApp" height={80} width={80} className='mx-auto lg:mx-0'/>
           ...
           <div className='flex text-center lg:text-left flex-col'>
              <Image src="/desktoplogo.svg" alt="mobileApp" height={80} width={80} className='mx-auto lg:mx-0'/>
           ...
           <div className='flex text-center lg:text-left flex-col'>
              <Image src="/digitalMarketingLogo.svg" alt="mobileApp" height={80} width={80} className='mx-auto lg:mx-0'/>
