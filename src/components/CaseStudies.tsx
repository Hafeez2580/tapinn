  ...
  return (
    <div className='text-center mt-16 '>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2  gap-1'>
          <div className="card w-100 lg:w-60 text-center">
           <figure><Image src="/mobileApp.png" alt="header" width={200} height={200} className='w-40 h-40 mx-auto'/></figure>
            <div className="card-body text-center">
              <h2 className="font-bold mt-4 text-center">Mobile Apps</h2>
              <p className='text-center'>Developing, Designing</p>
              <div className="card-actions justify-end">
                <Button className='mt-2 mx-auto' variant='secondary'>Read more</Button>
              </div>
            </div>
          </div>
          <div className="card w-100 lg:w-60">
           <figure><Image src="/header.svg" alt="car!" width={200} height={200} className='w-40 h-40 mx-auto'/></figure>
            <div className="card-body">
              <h2 className="font-bold mt-2">Web Designing</h2>
          ...
          <div className="card w-100 lg:w-60">
           <figure><Image src="/services.png" alt="car!" width={200} height={200} className='w-40 h-40 mx-auto'/></figure> 
            <div className="card-body">
              <h2 className="font-bold mt-2">Software Development</h2>
              <p>Developing, Designing</p>
              <div className="card-actions justify-end">
                <Button className='mt-2 mx-auto' variant='secondary'>Read more</Button>
              </div>
          ...
          <div className="card w-100 lg:w-60">
           <figure><Image src="/desktoplogo.svg" alt="car!" width={200} height={200} className='w-40 h-40 mx-auto'/></figure>
            <div className="card-body">
              <h2 className="font-bold mt-2">Online Marketing</h2>
              <p>Developing, Designing</p>
              <div className="card-actions justify-end">
                <Button className='mt-2 mx-auto' variant='secondary'>Read more</Button>
              </div>
