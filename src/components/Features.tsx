...
function Features() {
  return (
    <>
    <div className='container grid  grid-cols-1 lg:grid-cols-2 gap-3  mt-10'>
      <div>
      ...
      <div className='flex justify-center'>
        <Image src="/mobileApp.png" alt="mobileapp" height={350} width={350}/>
      </div>
    </div>
    <div className='container grid grid-cols-1 lg:grid-cols-2 gap-3 mt-10'>
     <div className='flex '>
        <Image src="/services.png" alt="mobileapp" height={350} width={350}/>
      </div>
      <div>
        <h2 className='text-3xl font-semibold'>We Offer a Full Range <br />of Digital Marketing Services!</h2>
        <p className=' my-6 text-gray-500'>Unlock your brand's full potential with our comprehensive digital marketing services. From strategic campaigns to social media management, our expert team drives impactful results. Stay ahead in the digital landscape.</p>
        <p className=' my-6 text-gray-700 font-semibold'>- p- partner with us for success.</p>
      </div>
    </div>
    </>
  )
